...
**Biópsia**:
Coleta de um pequeno pedaço de tecido quando há uma área suspeita durante a colposcopia, para análise em laboratório.
_Avoid_: tratar como parte obrigatória de toda colposcopia ou como diagnóstico final
